    ...
    return (
      <section>
        ...
        <ol className="list-group">
          ...
          Estado (State): Es un objeto que representa la información interna de un componente. Cuando el estado de un componente cambia, React se encarga de actualizar la interfaz de usuario de manera eficiente.
          </li>
          <li className="list-group-item">
          Ciclo de vida (Lifecycle): React proporciona métodos que se ejecutan en diferentes etapas del ciclo de vida de un componente, como montaje, actualización y desmontaje. Esto permite realizar acciones específicas en momentos específicos.
          </li>
          <li className="list-group-item">
          JSX (JavaScript XML): Es una extensión de JavaScript que permite escribir código similar a HTML dentro de archivos JavaScript. JSX facilita la creación de elementos de interfaz de usuario en React.
          </li>
        </ol>
      </section>
    );
